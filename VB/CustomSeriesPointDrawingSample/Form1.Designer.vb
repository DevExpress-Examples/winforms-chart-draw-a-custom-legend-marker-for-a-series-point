Namespace CustomSeriesPointDrawingSample
    Partial Public Class Form1
        ...
        Private Sub InitializeComponent()
            ...
            DirectCast(nestedDoughnutSeriesView1, System.ComponentModel.ISupportInitialize).BeginInit()
            Me.SuspendLayout()
            ' 
            ' chart
            ' 
            ...
            Me.Name = "Form1"
            Me.Text = "Form1"
            DirectCast(nestedDoughnutSeriesView1, System.ComponentModel.ISupportInitialize).EndInit()
