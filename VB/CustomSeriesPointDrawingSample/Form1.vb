...
#Region "#CustomPointDrawing"
        Private Sub OnCustomDrawSeriesPoint(ByVal sender As Object, ByVal e As DevExpress.XtraCharts.CustomDrawSeriesPointEventArgs)
            ...
            Using graphics As System.Drawing.Graphics = System.Drawing.Graphics.FromImage(image)
                Dim fillBrush As System.Drawing.Brush = If(isSelected, CType(New System.Drawing.Drawing2D.HatchBrush(System.Drawing.Drawing2D.HatchStyle.DarkDownwardDiagonal, e.LegendDrawOptions.Color, e.LegendDrawOptions.ActualColor2), System.Drawing.Brush), CType(New System.Drawing.SolidBrush(e.LegendDrawOptions.Color), System.Drawing.Brush))
...
#End Region
        ...
        Private Sub InitPhotoCache(ByVal employees As System.Collections.Generic.IEnumerable(Of CustomSeriesPointDrawingSample.Model.Employee))
            ...
            For Each employee In employees
                Dim stream As System.IO.MemoryStream = New System.IO.MemoryStream(employee.Photo)
